...
export function DigestActionPanel() {
  ...
  return (
    <form action={formAction} className="rounded-md border border-slate-200 bg-slate-50 p-3">
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <div>
          <p className="text-sm font-semibold text-slate-950">生成今日科技简报</p>
          <p className="mt-1 text-xs leading-5 text-slate-500">可选：基于下面的文章生成中文简报。未配置模型时会使用本地摘要。</p>
        </div>
        <GenerateButton />
      </div>
